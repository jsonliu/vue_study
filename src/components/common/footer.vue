<template>
  <div class="tabbar-view">
    <tabbar class="footer-wrapper"
            slot="bottom"
            v-on:on-index-change="change()"
            v-model="index">
      <!--使用img 和src-->
      ...
      <tabbar-item :link="{path:'/'}">
        <div slot="icon"
             class="item-image icon-home"></div>
        <div slot="icon-active"
             class="item-image icon-home-on"></div>
        <span slot="label"
              class="icon-msg">vuejs</span>
      </tabbar-item>
      <tabbar-item :link="{path:'/vux'}">
        <div slot="icon"
             class="item-image icon-community"></div>
        <div slot="icon-active"
             class="item-image icon-community-on"></div>
        <span slot="label"
              class="icon-msg">vux</span>
      </tabbar-item>
      <tabbar-item :link="{path:'/other'}">
        <div slot="icon"
             class="item-image icon-found"></div>
        <div slot="icon-active"
             class="item-image icon-found-on"></div>
        <span slot="label"
              class="icon-msg">自定义</span>
      </tabbar-item>
      <tabbar-item :link="{path:'/vuex'}">
        <div slot="icon"
             class="item-image icon-cart"></div>
        <div slot="icon-active"
             class="item-image icon-cart-on"></div>
        <span slot="label"
              class="icon-msg">vuex</span>
      </tabbar-item>
      <tabbar-item :link="{path:'/router'}">
        <div slot="icon"
             class="item-image icon-mine"></div>
        <div slot="icon-active"
             class="item-image icon-mine-on"></div>
        <span slot="label"
              class="icon-msg">router</span>
      </tabbar-item>
    </tabbar>
  </div>
</template>
