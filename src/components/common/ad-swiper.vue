<template>
    <div class="ad-swiper">
      <swiper :style="swiperStyle" :options="swiperOption" class="swiper-box"  ref="adswiper">
        <swiper-slide class="swiper-item" v-for="(imgUrl,index) in adsArr" :key="index" @click.native="onAdClick(index)">
          <img class="adimgview" v-lazy="imgUrl"/>
        </swiper-slide>
        <div v-show="adsArr.length>1" class="swiper-pagination" slot="pagination"></div>
      </swiper>
    </div>
</template>
